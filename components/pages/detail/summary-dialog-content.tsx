  ...
  return (
    <div className="max-h-[612px] overflow-auto">
      <Table className="w-full table-fixed border-separate border-spacing-0 font-medium">
        <TableHeader>
          <TableRow>
            <TableHead className="w-[128px] border-r border-b bg-zinc-100">
              カテゴリー
            </TableHead>
            <TableHead className="w-[90px] border-r border-b bg-zinc-100">
              評価
            </TableHead>
            <TableHead className="border-r border-b bg-zinc-100">
              長所
            </TableHead>
            <TableHead className="border-r border-b bg-zinc-100">
              改善点
        ...
        <TableBody>
          <TableRow>
            <TableCell className="border-r border-b bg-white p-4 align-middle">
              FV
            </TableCell>
            <TableCell
              className={cn(
            ...
            >
              <div className="text-lg">
                {gradeConversion(Number(ownCategoryScores?.FV) ?? 0)}
              </div>
              <div
                className="text-sm"
                style={{
            ...
            <TableCell className="border-r border-b bg-white p-4">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    summaryData?.FV.competitors_advantage !== ""
                      ? (summaryData?.FV.competitors_advantage ?? "")
                      : "なし",
                }}
              />
          ...
          <TableRow>
            ...
            >
              <div className="text-lg">
                {gradeConversion(Number(ownCategoryScores?.CTA) ?? 0)}
              </div>
              <div
                className="text-sm"
                style={{
            ...
            <TableCell className="border-r border-b bg-white p-4 align-top">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    summaryData?.CTA.competitors_advantage !== ""
                      ? (summaryData?.CTA.competitors_advantage ?? "")
                      : "なし",
                }}
              />
          ...
          <TableRow>
            ...
            <TableCell
              className={cn(
                "space-y-1 border-r border-b bg-white p-4 text-center align-middle",
                Number(ownCategoryScores?.CONTENTS) < 25
                  ? "text-[#DA2A2A]"
                  : "",
              )}
            >
              <div className="text-lg">
                {gradeConversion(Number(ownCategoryScores?.CONTENTS) ?? 0)}
              </div>
              <div
                className="text-sm"
                style={{
            ...
            <TableCell className="border-r border-b bg-white p-4 align-top">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    summaryData?.CONTENTS.competitors_advantage !== ""
                      ? (summaryData?.CONTENTS.competitors_advantage ?? "")
                      : "なし",
                }}
              />
          ...
          <TableRow>
            ...
            <TableCell
              className={cn(
                "space-y-1 border-r border-b bg-white p-4 text-center align-middle",
                Number(ownCategoryScores?.CREATIVE) < 25
                  ? "text-[#DA2A2A]"
                  : "",
              )}
            >
              <div className="text-lg">
                {gradeConversion(Number(ownCategoryScores?.CREATIVE) ?? 0)}
              </div>
              <div
                className="text-sm"
                style={{
            ...
            <TableCell className="border-r border-b bg-white p-4 align-top">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    summaryData?.CREATIVE.competitors_advantage !== ""
                      ? (summaryData?.CREATIVE.competitors_advantage ?? "")
                      : "なし",
                }}
              />
          ...
          <TableRow>
            ...
            <TableCell
              className={cn(
                "space-y-1 border-r border-b bg-white p-4 text-center align-middle",
                Number(ownCategoryScores?.ACCESSIBILITY) < 25
                  ? "text-[#DA2A2A]"
                  : "",
              )}
            >
              <div className="text-lg">
                {gradeConversion(Number(ownCategoryScores?.ACCESSIBILITY) ?? 0)}
              </div>
              <div
                className="text-sm"
                style={{
            ...
            <TableCell className="border-r border-b bg-white p-4 align-top">
              <div className="!text-[13px]">
                {summaryData?.ACCESSIBILITY.自社長所 !== ""
                  ? summaryData?.ACCESSIBILITY.自社長所
                  : "なし"}
              </div>
            </TableCell>
            <TableCell className="border-r border-b bg-white p-4 align-top">
              <div className="!text-[13px]">
                {summaryData?.ACCESSIBILITY.自社改善点 !== ""
                  ? summaryData?.ACCESSIBILITY.自社改善点
                  : "なし"}
              </div>
            </TableCell>
            <TableCell className="border-r border-b bg-white p-4 align-top">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    summaryData?.ACCESSIBILITY.competitors_advantage !== ""
                      ? (summaryData?.ACCESSIBILITY.competitors_advantage ?? "")
                      : "なし",
                }}
              />
