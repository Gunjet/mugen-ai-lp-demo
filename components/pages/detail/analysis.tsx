...
export default function DetailAnalysis() {
  ...
  useEffect(() => {
    if (tableRef.current) {
      ...
      const widthDivided =
        (urlMapping?.length ?? 0) < 4 ? 4 : (urlMapping?.length ?? 0);
    ...
    <div className="flex flex-col space-y-4 rounded-xl bg-white/80 p-8">
          ...
          <TableBody>
            <TableRow className="h-16 min-h-16">
              ...
              <TableCell className="sticky left-[250px] z-10 border-r-4 border-b border-double bg-[#F8FBFD] p-4 align-middle font-medium underline underline-offset-2">
                <Link
                  href={scoreDict?.[urlMapping?.[0].url ?? ""]?.url ?? ""}
                  target="_blank"
                >
            ...
            <TableRow>
              ...
              <TableCell className="sticky left-[250px] z-10 border-r-4 border-b border-double bg-[#F8FBFD] p-4">
                <div className="border-non-color mx-auto max-h-[253px] w-[129px] overflow-hidden border">
                  <Image
                    src={
                      typeof scoreDict?.[urlMapping?.[0].url ?? ""]
                        ?.image_full === "string" &&
                      scoreDict?.[
                        urlMapping?.[0].url ?? ""
                      ]?.image_full.startsWith("/dummy")
              ...
              {urlMapping?.slice(1).map((item, index) => (
                <TableCell
                  key={index}
                  className={cn("border-r border-b p-4 last:border-r-0")}
                >
                  <div className="border-non-color mx-auto max-h-[253px] w-[129px] overflow-hidden border">
                    <Image
                      src={
                        typeof scoreDict?.[item.url ?? ""]?.image_full ===
                          "string" &&
                        scoreDict?.[item.url ?? ""]?.image_full.startsWith(
                          "/dummy",
                        )
            ...
            <TableRow className="h-16">
              ...
              {urlMapping?.slice(1).map((item, index) => (
                <TableCell
                  key={index}
                  className={cn(
                    "border-r border-b p-4 text-center align-middle text-2xl font-medium last:border-r-0",
                  )}
                >
            ...
            <TableRow className="h-16">
              ...
              <TableCell className="sticky left-[250px] z-10 border-r-4 border-b border-double bg-[#F8FBFD] p-4 align-middle font-medium">
                <div className="text-corporate text-center">
                  {showPercentage
                    ? gradeConversion(
                        urlCategoryScores?.[urlMapping?.[0].url ?? ""]?.FV ?? 0,
                      )
                    : (urlCategoryScores?.[urlMapping?.[0].url ?? ""]?.FV ??
                      "N/A")}
                </div>
              </TableCell>
              {urlMapping?.slice(1).map((item, index) => (
                <TableCell
                  key={index}
                  className={cn(
                    "border-r border-b p-4 align-middle font-medium last:border-r-0",
                  )}
                >
                  <div className="text-center">
                    {showPercentage
                      ? gradeConversion(
                          urlCategoryScores?.[item.url ?? ""]?.FV ?? 0,
                        )
              ...
              <>
                {scoreDict?.[urlMapping?.[0].url ?? ""]?.result
                  ...
                  ?.map((r, qIndex) => (
                    ...
                    >
                      <TableCell className="sticky left-0 z-10 border-r border-b bg-[#F8FBFD] p-4 align-middle">
                        {r.question}
                      </TableCell>
                      <TableCell
                        className={cn(
                      ...
                      {urlMapping?.slice(1).map((item, index) => (
                        <TableCell
                          ...
                          className={cn(
                            ...
                            (scoreDict?.[item.url ?? ""]?.result
                              ?.filter((r2) => r2.category === r.category)
                              ?.find((r2) => r2.question === r.question)
                              ?.score ?? 0) < 2
                              ? "bg-[#F6F0F2]"
                              : "bg-[#F8FBFD]",
                          )}
                        >
                          {(scoreDict?.[item.url ?? ""]?.result
                            ?.filter((r2) => r2.category === r.category)
                            ?.find((r2) => r2.question === r.question)?.score ??
                            0) < 2 && (
                            <Image
                              src="/bad.svg"
                              alt="pin"
            ...
            <TableRow className="h-16">
              ...
              <TableCell className="sticky left-[250px] z-10 border-r-4 border-b border-double bg-[#F8FBFD] p-4 text-center align-middle font-medium">
                <div className="text-corporate text-center">
                  {showPercentage
                    ? gradeConversion(
                        urlCategoryScores?.[urlMapping?.[0].url ?? ""]?.CTA ??
                          0,
                      )
                    : (urlCategoryScores?.[urlMapping?.[0].url ?? ""]?.CTA ??
                      "N/A")}
              ...
              {urlMapping?.slice(1).map((item, index) => (
                <TableCell
                  key={index}
                  className={cn(
                    "border-r border-b p-4 text-center align-middle font-medium last:border-r-0",
                  )}
                >
                  <div className="text-center">
                    {showPercentage
                      ? gradeConversion(
                          urlCategoryScores?.[item.url ?? ""]?.CTA ?? 0,
                        )
            ...
            <TableRow className="h-16">
              ...
              <TableCell className="sticky left-[250px] z-10 border-r-4 border-b border-double bg-[#F8FBFD] p-4 text-center align-middle font-medium">
                <div className="text-corporate text-center">
                  {showPercentage
                    ? gradeConversion(
                        urlCategoryScores?.[urlMapping?.[0].url ?? ""]
                          ?.CONTENTS ?? 0,
                      )
                    : (urlCategoryScores?.[urlMapping?.[0].url ?? ""]
                        ?.CONTENTS ?? "N/A")}
              ...
              {urlMapping?.slice(1).map((item, index) => (
                ...
                >
                  <div className="text-center">
                    {showPercentage
                      ? gradeConversion(
                          urlCategoryScores?.[item.url ?? ""]?.CONTENTS ?? 0,
                        )
                      : (urlCategoryScores?.[item.url ?? ""]?.CONTENTS ??
                        "N/A")}
                  </div>
                </TableCell>
              ))}
              ...
              {urlMapping?.slice(1).map((item, index) => (
                ...
                >
                  <div className="text-center">
                    {showPercentage
                      ? gradeConversion(
                          urlCategoryScores?.[item.url ?? ""]?.CREATIVE ?? 0,
                        )
                      : (urlCategoryScores?.[item.url ?? ""]?.CREATIVE ??
                        "N/A")}
                  </div>
                </TableCell>
              ))}
              ...
              {urlMapping?.slice(1).map((item, index) => (
                ...
                >
                  <div className="text-center">
                    {showPercentage
                      ? gradeConversion(
                          urlCategoryScores?.[item.url ?? ""]?.ACCESSIBILITY ??
                            0,
                        )
                      : (urlCategoryScores?.[item.url ?? ""]?.ACCESSIBILITY ??
                        "N/A")}
      ...
      <div className="overflow-x-auto">
        <Table className="w-full table-auto border-collapse">
          <TableHeader className="bg-zinc-100">
            <TableRow>
              <TableHead className="w-1/3 border-t border-r px-4 py-2">
                PoD：自社が選ばれる理由・強み
              </TableHead>
              <TableHead className="w-1/3 border-t border-r px-4 py-2">
                PoP：競合に揃えるべきポイント
              </TableHead>
              <TableHead className="w-1/3 border-t px-4 py-2">
                PoF：顧客離脱のリスク
              </TableHead>
            </TableRow>
          </TableHeader>
