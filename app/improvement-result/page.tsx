      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button className="flex h-10 min-w-[192px] cursor-pointer items-center justify-center gap-2 rounded-full bg-[#CCCCCC] pr-[5px] pl-[24px] text-[12px] font-semibold text-white shadow-none hover:bg-[#CCCCCC]">
              改善案をダウンロード
              <DownloadIcon className="h-5 w-5" />
            </Button>
          </div>
